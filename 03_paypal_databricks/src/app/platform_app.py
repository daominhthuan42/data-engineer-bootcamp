...
class PlatformApp:
    ...
    DEFAULT_ENTITIES    = ["transactions", "dispute_transactions"]
    ...
    def __init__(self, spark: SparkSession, logger: logging, catalog_name: str):
        ...
        # Init logger
        if logger is None:
            self.logger = LoggerFactory().setup_logger(log_dir=LOG_DIR)
        self.logger = logger
    ...
    def create_volume(self, schema_name: str, volume_name: str) -> None:
        ...
        """
        self.logger.info("Initializing Unity Catalog and schemas...")
        try:
            ...
            self.logger.info("Catalog and schemas initialized successfully.")
        except Exception:
