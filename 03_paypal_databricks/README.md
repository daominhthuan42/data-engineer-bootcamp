# 03_paypal_databricks

The '03_paypal_databricks' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/03_paypal_databricks/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] 03_paypal_databricks_etl` to your workspace.
