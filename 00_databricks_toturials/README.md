# 00_databricks_toturials

The '00_databricks_toturials' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/00_databricks_toturials/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] 00_databricks_toturials_etl` to your workspace.
