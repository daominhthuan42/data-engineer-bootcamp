...
The '01_fmcg_domain' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/01_fmcg_domain/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] 01_fmcg_domain_etl` to your workspace.
